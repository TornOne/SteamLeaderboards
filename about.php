...
<div class="about">
	...
	<ul>
		...
		<li>The last successful update was very long ago.
			<p>Again, due to server limitations, I can only trigger an update when someone visits the site. If no one has been here for a long while, the rankings will be outdated for about 15 minutes while they are updated. Alternatively, it is possible that the update failed, in which case it should probably try again and succeed the next day. Failing multiple days in a row is an indication that Steam's undergone changes and the updater might need to be reworked. Hopefully this does not happen. (EDIT: Updates have been failing on most days since early 2019. I will have to rework the updater when I get the time. In the meanwhile, my apologies.)</p></li>
		<li>The page is down.
